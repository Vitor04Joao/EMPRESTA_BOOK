...
<body>
    <div class="container-fluid" style="padding: 20px;">
        <a href="menu.php">
        <h2><i class="fa-solid fa-arrow-left"></i></a>Lista de Autores</h2>
        <br><br>
        ...
        <table id="table_id" class="table table-striped table-hover">
            ...
            <tr style="background-color:rgb(29, 29, 29); color: white;">
                    ...
                    <th scope="col">País de Nascimento</th>
            ...
            <tr>
                ...
                <td style="vertical-align: inherit;"> <?php echo $paisNascimento ?> </td>
                <td style="vertical-align: inherit;">
                    ...
                    <a href="editar_autor.php?id=<?php echo $id ?>">
        ...
        <div style="text-align: right; margin-top:20px;">
            <a href="adicionar_autor.php" role="button" class="btn btn-success btn-lg">Cadastrar Autor</a>
            &nbsp;
