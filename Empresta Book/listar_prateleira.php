...
<script>
    function confirmacao(id) {
        if (id && confirm("Deseja remover esse registro?")) {
            window.location.href = "deletar_prateleira.php?id=" + id;
        }
    }
</script>
...
<body>
    <div class="container-fluid" style="padding: 20px;">
        <a href="menu.php">
        <h2><i class="fa-solid fa-arrow-left"></i></a>Lista das Prateleira:</h2>
        <br><br>
...
// Consulta SQL com JOIN para buscar o nome da estante associada à prateleira
$sql = "
    SELECT 
        p.id, 
        p.numero, 
        ...
        p.observacao 
    FROM Prateleira p
    JOIN Estante e ON p.estante_id = e.id
";
...
while ($array = mysqli_fetch_array($busca)) {
    $id = $array['id'];
    $numero = $array['numero'];
    $id_estante = $array['estante_id'];
    $nome_estante = $array['nome_estante']; 
    $observacao = $array['observacao'];
?>
           
            <tr>
                <td style="vertical-align: inherit;"> <?php echo $numero ?> </td>
                <td style="vertical-align: inherit;"> <?php echo $nome_estante ?> </td>
                <td class="obs" style="vertical-align: inherit;"> <?php echo $observacao ?> </td>
                <td style="vertical-align: inherit;">
                   
                   
                  
                    <a href="editar_prateleira.php?id=<?php echo $id ?>">
        ...
        <div style="text-align: right; margin-top:20px;">
            <a href="adicionar_prateleira.php" role="button" class="btn btn-success btn-lg">Cadastrar Prateleira</a>
            &nbsp;
