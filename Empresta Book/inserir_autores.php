...
$sql ="INSERT INTO Autor (nome, dataNascimento, paisNascimento)
VALUES ('$nome' ,'$dataNascimento', '$paisNascimento')";
    ...
    <div class="container">
        ...
        <img src="IMG/success.png"  alt="Success" width="35px">
            ...
            <div style="padding-top: 20px;">
                <a href="adicionar_autor.php" role="button" class="btn btn-primary">Voltar</a>
            </div>
        </div>
    </div>
</body>
