...
$sql ="INSERT INTO Bibliotecario(nome, dataNascimento, email, cpf, telefone, nivel, senha, usuario)
VALUES ('$nome' ,'$dataNascimento', '$email', '$cpf', '$telefone','$nivel', '$senha', '$usuario')";
    ...
    <div class="container">
        ...
        <img src="IMG/success.png"  alt="Success" width="35px">
            ...
            <div style="padding-top: 20px;">
                <a href="login.php" role="button" class="btn btn-primary">Voltar ao login</a>
            </div>
        </div>
    </div>
</body>
