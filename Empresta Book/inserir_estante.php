...
$sql ="INSERT INTO Estante (nome, tipoAcervo, observacao)
VALUES ('$nome', '$tipoAcervo', '$observacao')";
...
<body>
    <div class="container">
        ...
        <img src="IMG/success.png"  alt="Success" width="35px">
            ...
            <h2>Estante adicionada com sucesso!!</h2>
            
            <div style="padding-top: 20px;">
                <a href="adicionar_estante.php" role="button" class="btn btn-primary">Voltar</a>
            </div>
        </div>
    </div>
</body>
