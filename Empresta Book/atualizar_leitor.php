...
nome= '$nome' ,dataNascimento = '$dataNascimento', email = '$email', matricula = '$matricula',telefone = '$telefone', tipoLeitor = '$tipoLeitor', numero = '$numero', bairro = '$bairro',cidade = '$cidade', estado = '$estado', logradouro = '$logradouro'
WHERE id = $id ";
